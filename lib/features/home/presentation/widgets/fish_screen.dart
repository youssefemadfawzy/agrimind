...
class _FishScreenState extends State<FishScreen> {
  final List<Order> _allOrders = const [
    Order(name: 'kenzy', amount: 316),
    Order(name: 'abed', amount: 242),
    Order(name: 'montasser', amount: 837),
    Order(name: 'sailas', amount: 874),
    Order(name: 'came', amount: 874),
  ];
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const _WalletCard(),
            const AIHealthAnalytics(image: AppImages.fishaihealth,),
